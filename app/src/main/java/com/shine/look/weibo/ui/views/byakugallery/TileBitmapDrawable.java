package com.shine.look.weibo.ui.views.byakugallery;
...
public class TileBitmapDrawable extends Drawable {
    ...
    public static void attachTileBitmapDrawable(ImageView imageView, byte[] bytes, Drawable placeHolder, OnInitializeListener listener) {
        new InitializationTask(imageView, placeHolder, listener).execute(bytes);
    }
